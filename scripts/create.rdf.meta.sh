...
rapper -gq /var/www/lib/worldbank-linkeddata/data/meta/meta.ttl -o rdfxml > /var/www/lib/worldbank-linkeddata/data/meta/meta.rdf
echo "Created /var/www/lib/worldbank-linkeddata/data/meta/meta.rdf"
